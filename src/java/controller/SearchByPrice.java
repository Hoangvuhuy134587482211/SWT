...
public class SearchByPrice extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int from = Integer.parseInt(fromprice);
            int to = Integer.parseInt(toprice);

            ProductDAO pd = new ProductDAO();
            List<Product> list = pd.getProductByPrice(from, to);
            request.setAttribute("data", list);

            List<Category> listCategory = pd.GetAllCategory();
